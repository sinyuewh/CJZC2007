<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ZcDetailKind.ascx.cs"
    Inherits="ZiChan_ZcDetailKind" %>
...
<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <td align="center">
            ...
            |
            <asp:LinkButton ID="LinkButton11" runat="server" CssClass="blue1" CommandArgument="11"
                OnCommand="LinkButton1_Command">3.诉讼情况</asp:LinkButton>
            |
            <asp:LinkButton ID="LinkButton6" runat="server" CssClass="blue1" CommandArgument="6"
                OnCommand="LinkButton1_Command">4.时效管理</asp:LinkButton>
            |
            <asp:LinkButton ID="LinkButton2" runat="server" CssClass="blue1" CommandArgument="2"
                OnCommand="LinkButton1_Command">5.尽职调查</asp:LinkButton>
           ...
           <%-- 
            ...
            <asp:LinkButton ID="LinkButton5" runat="server" CssClass="blue1" CommandArgument="5"
                OnCommand="LinkButton1_Command">6.财务数据</asp:LinkButton>
            |
            <asp:LinkButton ID="LinkButton7" runat="server" CssClass="blue1" CommandArgument="7"
                OnCommand="LinkButton1_Command">7.抵债物资</asp:LinkButton>
            |
            <asp:LinkButton ID="LinkButton8" runat="server" CssClass="blue1" CommandArgument="8"
                OnCommand="LinkButton1_Command">8.所有附件</asp:LinkButton>
            ...
            &nbsp;&nbsp; <span id="spaninfo1" runat="server"><a href='OldHkInfo.aspx?num2=<%=this.DangAnNum %>' target="_blank" class ="blue">
                [老资料]</a> </span>
        </td>
    </tr>
</table>
