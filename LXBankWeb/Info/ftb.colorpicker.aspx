...
<body style="background-color: d4d0c8; margin: 2 2 2 2;">
    <form runat="server">
        <table cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                <td>
                    <input type="text" name="ColorText" id="ColorText" style="width: 60; height: 22;"
                        onkeyup="userInput(this);"></td>
                <td align="center">
                    <div id="PreviewDiv" style="width: 50; height: 20; border: 1 solid black; background-color: #ffffff;">
                        &nbsp;</div>
                </td>
                <td align="right">
                    <input type="button" value="Use Color" onclick="returnColor(ColorText.value);" id="ColorButton"
                        style="width: 80;"></td>
            </tr>
        </table>
    </form>
