<%@ page language="C#" masterpagefile="~/Common/Master/JueCe.master" autoeventwireup="true" inherits="JueCeZhiChi_StatHuiKuan, App_Web_ckqqdyzb" title="回款统计" stylesheettheme="CjzcWeb" %>
                                                ...
                                                <asp:TemplateField HeaderText="">
                                                    ...
                                                    <ItemTemplate>
                                                        <a class="blue1" href="StatHuiKuanInfo.aspx?zcid=<%#Eval("zcid") %>&&bid=<%#Eval("bid") %>"
                                                            title="<%#Eval("hkje") %>">
                                                            <%#PubComm.GetNumberFormat(Eval("hkje")) %>
                                                        </a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
