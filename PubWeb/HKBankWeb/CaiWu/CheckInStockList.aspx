<%@ page language="C#" masterpagefile="~/Common/Master/CaiWu.master" autoeventwireup="true" inherits="CaiWu_CheckingBill, App_Web_mm-bb4su" title="审核入库单据" stylesheettheme="CjzcWeb" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                ...
                <HeaderStyle HorizontalAlign="Center" />
                <ItemTemplate>
                    <a href="<%# Eval("EditASP") %>?id=<%# Eval("id") %>" class="blue1">审核</a>
