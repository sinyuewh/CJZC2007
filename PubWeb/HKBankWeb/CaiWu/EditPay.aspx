<%@ page language="C#" masterpagefile="~/Common/Master/CaiWu.master" autoeventwireup="true" inherits="CaiWu_EditShouKuan, App_Web_zasnkcfh" title="支出单据" stylesheettheme="CjzcWeb" %>
    ...
    <table width="95%" align="center" border="0" cellpadding="1" cellspacing="1" bgcolor="#c5c5c5">
        ...
        <tr height="25">
            ...
            <td>
                备注：</td>
            <td>
               <asp:TextBox ID="remark" runat="server" TextMode="multiLine" Height="60"></asp:TextBox>
            </td>
        </tr>
         <tr height="30">
            <td colspan="4" align="center">
                ...
                <asp:Button ID="Button3" runat="server" Text="更新单据" OnClick="Button3_Click" />&nbsp;
