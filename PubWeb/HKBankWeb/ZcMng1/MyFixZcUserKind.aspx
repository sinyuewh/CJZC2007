<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng1_MyFixZcUserKind, App_Web_vqsfoy_m" title="调整我负责资产的自定义分类" stylesheettheme="CjzcWeb" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="调整">
                            ...
                            <ItemTemplate>
                                <a href="JavaScript:SetUserKind(12);" class="blue1" target="_self">替换</a> | <a href="JavaScript:SetUserKind(22);"
                                    class="blue1" target="_self">追加</a> | <a href="JavaScript:SetUserKind(32);" class="blue1"
                                        target="_self">清除</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
