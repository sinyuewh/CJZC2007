<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZiChan_ZcDetail4, App_Web_egwtw3-i" title="方案执行" stylesheettheme="CjzcWeb" %>
    ...
    <table width="95%" align="center" border="0" cellpadding="1" cellspacing="1" bgcolor="#c5c5c5">
        ...
        <tr height="30">
            <td colspan="4" align="center" style="height: 30px">
                ...
                &nbsp;<input id="Button5" runat="server" type="button" value="打印资料" class="but" onclick="return Button5_onclick()" />
                &nbsp; <span id="MyButtonGroup" runat="server" >
                    <asp:Button ID="Button21" runat="server" CommandArgument="21" Text="协商谈判" OnCommand="Button01_Command" OnClick="Button21_Click" />
