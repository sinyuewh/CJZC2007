<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng2_AddZcCzfs, App_Web_cjivnna6" title="增加资产处置方式" stylesheettheme="CjzcWeb" %>
<%-- 在此处添加内容控件 --%>
