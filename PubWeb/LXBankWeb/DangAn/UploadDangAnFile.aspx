<%@ page title="档案电子稿上传" language="C#" masterpagefile="~/Common/Master/DangAn.master" autoeventwireup="true" inherits="DangAn_UploadDangAnFile, App_Web_d1onhsud" stylesheettheme="CjzcWeb" %>
<script runat="server">
    ...
    private void InsertDangAnDianZiFile(String num2,FileUpload file1)
    {
        ...
        String fileName2=PubComm.GetMd5(fileName1+System.Guid.NewGuid().ToString())+Extension;
