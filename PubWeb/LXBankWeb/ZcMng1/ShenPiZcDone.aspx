<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng1_ShenPiZcDone, App_Web_z4gjhdph" title="我审批过的资产" stylesheettheme="CjzcWeb" %>
<%-- 在此处添加内容控件 --%>
<%-- 在此处添加内容控件 --%>
            ...
            <td>
                <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SPtime" HeaderText="批阅时间" DataFormatString="{0:yyyy-MM-dd}"
                            HtmlEncode="False">
