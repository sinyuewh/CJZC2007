<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng1_ZcBaoGL, App_Web_jdf3giep" title="资产包管理" stylesheettheme="CjzcWeb" %>
                ...
                <asp:GridView ID="GridView1" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="bzeren1" HeaderText="协办人">
                         ...
                         <asp:BoundField DataField="bzeren2" HeaderText="协办人2">
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        </asp:BoundField>
