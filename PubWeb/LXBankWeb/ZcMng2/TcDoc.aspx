<%@ page language="C#" autoeventwireup="true" inherits="ZcMng2_TcDoc, App_Web_qf07ssj0" stylesheettheme="CjzcWeb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>长江资产公司不良贷款逐户调查表</title>
</head>
            ...
            <table width="95%" align="center" border="0" cellpadding="1" cellspacing="1" bgcolor="#c5c5c5">
                <tr height="30">
                    <td colspan="2" align="Center" bgcolor="#5d7b9d">
                        <strong><font color="#ffffff">不 良 贷 款 逐 户 调 查 表</font></strong>
                    </td>
                </tr>
                <colgroup>
                ...
                <tr height="30" bgcolor="white" id="Row1" runat="server">
                    ...
                    <td>
                        <p style="line-height: 150%">
                            <a href="<%#Application["root"] %>/Common/Model/长江资产公司不良贷款逐户调查表.doc" target="_blank"
                                class="blue1">长江资产公司不良贷款逐户调查表.doc</a>&nbsp; （提示：下载模板填写各栏信息保存到本地硬盘，然后将文件上传即可。）</p>
                    </td>
                </tr>
                <tr height="30" bgcolor="white" id="Row2" runat="server">
                    ...
                    <td>
                        <a href="<%#Application["root"] %>/Common/AttachFiles/<%#AttachFileName%>" target="_blank"
                            class="blue1">长江资产公司不良贷款逐户调查表.doc</a>
                    </td>
                </tr>
