...
<script language="C#" runat="server">
    ...
    // Messages
    private string NoFileMessage = "没有选择文件";
    private string UploadSuccessMessage = "上传文件成功";
    private string NoImagesMessage = "没有图片";
    private string NoFolderSpecifiedMessage = "没有文件夹";
    private string NoFileToDeleteMessage = "没有文件要删除";
    private string InvalidFileTypeMessage = "无效的图形文件类型";
            ...
            if (CurrentImagesFolder.Value != "")
            {
                if (UploadFile.PostedFile.FileName.Trim() != "")
                {
                    if (IsValidFileType(UploadFile.PostedFile.FileName))
                    {
                        ...
                        {
                            //ResultsMessage.Text = "您的文件上传错误：: " + ex.Message;
                            ResultsMessage.Text = "抱歉：发生了一个错误" + ex.Message;
                        }
                    }
                    else
                    {
...
<tr><td height=16 style="padding-left:10px;border-top: 1 solid #999999; background-color:#99ccff;">
	...
	<tr>
		...
		<td valign=top><asp:button id="UploadImage" Text="上传图片" runat="server" onclick="UploadImage_OnClick" /></td>
		<td valign=top><asp:button id="DeleteImage" Text="删除图片" runat="server" onclick="DeleteImage_OnClick" /></td>
		<td valign=middle>		
	</tr>
	<tr>
		<td colspan=3>
