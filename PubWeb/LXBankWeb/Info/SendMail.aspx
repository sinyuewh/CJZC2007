<%@ page language="C#" masterpagefile="~/Common/Master/Info.master" autoeventwireup="true" inherits="Info_SendMail, App_Web_lh9kwmkt" title="发件箱" stylesheettheme="CjzcWeb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%">
        <tr>
            <td align="center">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" Width="100%"
                    SkinID="gridviewSkin" DataKeyNames="ID" OnSorting="GridView1_Sorting">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="收件人" DataField="to1" HeaderStyle-HorizontalAlign="Center"
                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="15%"></asp:BoundField>
                        <asp:TemplateField HeaderText="主题" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <a class="blue1" href="<%#Application["root"] %>/Info/AlreadySendMail.aspx?id=<%#Eval("ID") %>">
                                    <%#Eval("title") %>
                                </a>
                            </ItemTemplate>
                            <ItemStyle Width="60%" />
        ...
        <tr runat="server"  id="info2">
            <td>
                <input id="Button1" type="button" value="删除" class="but" onclick="return DelEmail(2)" />
            </td>
        </tr>
        <tr>
            <td>
