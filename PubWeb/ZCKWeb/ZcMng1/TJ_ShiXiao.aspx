<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="JueCeZhiChi_TJ_ShiXiao, App_Web_-yo2hwel" title="时效统计" stylesheettheme="CjzcWeb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script language="javascript">
        ...
        function openPrintWindow()
        {
            ...
            var url="../JueCeZhiChi/TablePrint.aspx?tab1="+t2.id+"&maxCol=5&width=600&tabRow="+t2.rows.length;
