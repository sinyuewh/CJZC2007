<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng1_MyDepartZcTime0, App_Web_-z3ilga5" title="部门资产时效警告" stylesheettheme="CjzcWeb" %>
<%-- 在此处添加内容控件 --%>
