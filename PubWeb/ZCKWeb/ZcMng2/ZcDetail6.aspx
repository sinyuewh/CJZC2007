<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng2_ZcDetail6, App_Web_kckafmby" title="资产时效管理" stylesheettheme="CjzcWeb" %>
    ...
    <table width="95%" align="center" border="0" cellpadding="1" cellspacing="1" bgcolor="#c5c5c5">
        ...
        <tr height="30">
            <td colspan="7" align="center">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;
                <input id="Button2" runat="server" type="button" value="打印资产时效数据" class="but" onclick="return Button2_onclick()" style="width: 125px" />
            </td>
        </tr>
    </table>
</asp:Content>
