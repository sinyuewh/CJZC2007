<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZiChan_ZcDetail1, App_Web_kckafmby" title="基本资料" stylesheettheme="CjzcWeb" %>
    ...
    <table width="95%" align="center" border="0" cellpadding="1" cellspacing="1" bgcolor="#c5c5c5">
        ...
        <tr height="25">
            ...
            <td>
                ...
                <asp:Label ID="time0_1" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr height="25">
            <td>
        ...
        <tr height="25">
            ...
            <td>
                &nbsp;<asp:TextBox ID="zzjg" runat="server"></asp:TextBox>
        ...
        <tr height="25">
            ...
            <td>
                ...
                <asp:Label ID="clsj_1" runat="server"></asp:Label>
            </td>
            <td>
                注册资本：
            </td>
        ...
        <tr height="25">
            ...
            <td>
                &nbsp;<asp:DropDownList ID="dqjj" runat="server">
                </asp:DropDownList>
            ...
            <td>
                ...
                <asp:Label ID="qygm_1" runat="server"></asp:Label>
            </td>
        </tr>
        <tr height="25">
            <td>
        ...
        <tr height="25">
            ...
            <td>
                &nbsp;<asp:DropDownList ID="yxzzzk" runat="server">
                </asp:DropDownList>
        ...
        <tr height="25">
            ...
            <td>
                ...
                <asp:Label ID="xdri_1" runat="server"></asp:Label>
            </td>
            <td>
                贷款首次发放日期：
            </td>
            <td>
                &nbsp;<asp:TextBox ID="dkffrq1" runat="server"></asp:TextBox>
                <asp:Label ID="dkffrq1_1" runat="server"></asp:Label>
            </td>
        </tr>
        <tr height="25">
            <td>
            ...
            <td>
                &nbsp;<asp:TextBox ID="jklsh" runat="server"></asp:TextBox>
            ...
            <td>
                ...
                <asp:Label ID="dkye_1" runat="server"></asp:Label>
            </td>
        </tr>
        <tr height="25">
            <td>
        ...
        <tr height="25">
            ...
            <td>
                &nbsp;<asp:TextBox ID="zjycszje" runat="server"></asp:TextBox>
                <asp:Label ID="zjycszje_1" runat="server"></asp:Label>
            </td>
            <td>
                主要担保方式：
            </td>
        ...
        <tr height="25">
            ...
            <td>
                &nbsp;<asp:TextBox ID="yyldxt" runat="server"></asp:TextBox>
                <asp:Label ID="yyldxt_1" runat="server"></asp:Label>
            </td>
        </tr>
        <tr height="25">
            <td>
            ...
            <td>
                &nbsp;<asp:TextBox ID="xcyqrq" runat="server"></asp:TextBox>
                <asp:Label ID="xcyqrq_1" runat="server"></asp:Label>
            </td>
            <td>
                进入不良时间：
            </td>
            <td>
                &nbsp;<asp:TextBox ID="jrblsj" runat="server"></asp:TextBox>
                <asp:Label ID="jrblsj_1" runat="server"></asp:Label>
            </td>
        </tr>
        <tr height="25">
            <td>
        ...
        <asp:Repeater ID="Repeater3" runat="server">
            <ItemTemplate>
                <tr height="25">
                    ...
                    <td>
                        <a class="blue" target="_blank" href='<%=Application["root"]%>/SeeDAFile.aspx?fileName=<%#Eval("ajTrueFile")%>'><%#Eval("ajfile")%></a>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
