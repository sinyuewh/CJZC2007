<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng2_ZcDetail9, App_Web_kckafmby" title="资产担保情况" stylesheettheme="CjzcWeb" %>
    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand"
        ...
        <ItemTemplate>
            <tr height="25">
                ...
                <td>
                    <%#Comm.GetNumberFormat(Eval("wpjz"))%>
                </td>
                <td>
