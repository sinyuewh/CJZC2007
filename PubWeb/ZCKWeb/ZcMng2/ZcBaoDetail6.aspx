<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng2_ZcBaoDetail6, App_Web_rg5dne7w" title="资产包内所有附件" stylesheettheme="CjzcWeb" %>
    ...
    <asp:Repeater ID="Repeater1" runat="server">
        ...
        <ItemTemplate>
            <tr height="25">
                ...
                <td>
                    <%#Comm.GetString1(Eval("statusText")) %>
                </td>
                <td>
                    <%#Eval("filename")%>
                </td>
