<%@ page language="C#" autoeventwireup="true" inherits="ZcMng2_Zcywczsbb, App_Web_gyjcweka" stylesheettheme="CjzcWeb" %>
                ...
                <asp:Repeater ID="Repeater6" runat="server">
                    ...
                    <ItemTemplate>
                        <tr height="25">
                            ...
                            <td>
                                <%#Comm.GetNumberFormat(Eval("czjg"))%>
                            </td>
                            <td>
                                <%#Comm.GetNumberFormat(Eval("czss"))%>
                            </td>
                            <td>
                                <%#Eval("qcl")%>
                            </td>
                            <td>
                                <%#Comm.GetNumberFormat(Eval("yjfy"))%>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
