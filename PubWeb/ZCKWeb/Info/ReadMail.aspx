<%@ page language="C#" masterpagefile="~/Common/Master/Info.master" autoeventwireup="true" inherits="Info_ReadMail, App_Web_6dm0odi6" title="阅读邮件" validaterequest="false" stylesheettheme="CjzcWeb" %>
                        ...
                        <tr height="25">
                            <td align="left">
                                附 件：<a href='<%#Application["root"]%>/Common/MailFiles/<%#Eval("file1") %> ' target="_blank">
                                    <asp:Label ID="labFile" runat="server" Text='<%#Comm.GetString(Eval("file1")) %>'></asp:Label><br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                        href='<%#Application["root"]%>/Common/MailFiles/<%#Eval("file2") %> ' target="_blank">
                                        <asp:Label ID="Label1" runat="server" Text='<%#Comm.GetString(Eval("file2")) %>'></asp:Label><br />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                            href='<%#Application["root"]%>/Common/MailFiles/<%#Eval("file3") %> ' target="_blank">
                                            <asp:Label ID="Label2" runat="server" Text='<%#Comm.GetString(Eval("file3")) %>'></asp:Label><br />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                href='<%#Application["root"]%>/Common/MailFiles/<%#Eval("file4") %> ' target="_blank">
                                                <asp:Label ID="Label3" runat="server" Text='<%#Comm.GetString(Eval("file4")) %>'></asp:Label><br />
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
                                                    href='<%#Application["root"]%>/Common/MailFiles/<%#Eval("file5") %> ' target="_blank">
                                                    <asp:Label ID="Label4" runat="server" Text='<%#Comm.GetString(Eval("file5")) %>'></asp:Label>
