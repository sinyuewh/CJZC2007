<%@ page language="C#" masterpagefile="~/Common/Master/SystemAdmin.master" autoeventwireup="true" inherits="XtGL_UserMng, App_Web_de5ib_om" title="用户管理" stylesheettheme="CjzcWeb" %>
        ...
        <tr>
            <td width="98%" valign="top">
                ...
                状态过滤：<asp:DropDownList ID="status1" runat="server">
                 ...
                 &nbsp;&nbsp;
                 <asp:Button ID="butTongBu" runat ="server" Text ="同步汉口银行用户资料" />
                </div>
