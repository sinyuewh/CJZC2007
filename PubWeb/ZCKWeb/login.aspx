<%@ page language="C#" autoeventwireup="true" inherits="login, App_Web_svbsm3je" stylesheettheme="CjzcWeb" %>
                                ...
                                <tr>
                                    <td colspan="2">
                                        登陆密码：<asp:TextBox ID="password" runat="server" TextMode="Password" Width="130px"
                                            ...
                                            <asp:CheckBox ID="chk1" runat ="server" />记住密码
                                    </td>
                                </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left">
                                                    <asp:RadioButtonList ID="db" runat="server">
                                                        ...
                                                        <asp:ListItem Value="1" Text="汉口银行资产库"></asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </td>
                                            </tr>
                                        </table>
