<%@ page language="C#" masterpagefile="~/Common/Master/DangAn.master" autoeventwireup="true" inherits="DangAn_ShowPrintDetail, App_Web_gn-rd1mt" title="文件复印单明细页面" stylesheettheme="CjzcWeb" %>
