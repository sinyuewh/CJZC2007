<%@ page language="C#" masterpagefile="~/Common/Master/CaiWu.master" autoeventwireup="true" inherits="CaiWu_EditShouKuan, App_Web_ljgze5ul" title="审核入库单据" stylesheettheme="CjzcWeb" %>
    ...
    <table width="95%" align="center" border="0" cellpadding="1" cellspacing="1" bgcolor="#c5c5c5">
        ...
        <tr height="30">
            <td colspan="4" align="center">
                ...
                <input id="Button2" type="button" class="but" value="退出返回" runat="server" /></td>
        </tr>
    </table>
