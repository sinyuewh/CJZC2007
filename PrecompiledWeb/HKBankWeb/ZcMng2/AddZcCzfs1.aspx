<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng2_AddZcCzfs1, App_Web_wis9ndrf" title="增加资产包处置方式" stylesheettheme="CjzcWeb" %>
    ...
    <table width="85%" align="center" border="0" cellpadding="1" cellspacing="1" bgcolor="#c5c5c5">
        ...
        <tr height="25">
            <td colspan="2" align="center" bgcolor="#5d7b9d">
                <strong><font color="#ffffff">增 加 资 产 包 处 置 方 式 信 息 </font></strong>
            </td>
        </tr>
        <tr height="25">
            <td>
