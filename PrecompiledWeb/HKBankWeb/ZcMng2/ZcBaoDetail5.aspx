<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng2_ZcBaoDetail5, App_Web_dbor6yme" title="资产包的财务数据" stylesheettheme="CjzcWeb" %>
    ...
    <asp:Repeater ID="Repeater21" runat="server">
        ...
        <ItemTemplate>
            <tr height="25">
                ...
                <td>
                    <%#PubComm.GetNumberFormat(Eval("zchj"))%>
                </td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
