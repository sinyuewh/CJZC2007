<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng1_EditZcBao, App_Web_spvftmnd" title="资产包维护" stylesheettheme="CjzcWeb" %>
...
<%--        <tr height="25">
        ...
        <tr heiht="25">
            ...
            <td>
                ...
                &nbsp;&nbsp;
                <asp:TextBox ID="Bzeren2" runat="server"></asp:TextBox>
