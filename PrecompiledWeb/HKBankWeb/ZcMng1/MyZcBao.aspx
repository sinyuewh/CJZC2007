<%@ page language="C#" masterpagefile="~/Common/Master/ZcMng.master" autoeventwireup="true" inherits="ZcMng1_MyZcBao, App_Web_spvftmnd" title="我负责的资产包" stylesheettheme="CjzcWeb" %>
    ...
    <div style="margin-top: 10; background-color: #f0f8ff; border: 1px solid silver;
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="协办人">
                    <ItemTemplate>
                        <%#Eval("zeren1") %>
                    </ItemTemplate>
