<%@ page title="档案查询申请单列表" language="C#" masterpagefile="~/Common/Master/DangAn.master" autoeventwireup="true" inherits="DangAn_BorrowList, App_Web_widkftde" stylesheettheme="CjzcWeb" %>
