<%@ Page Language="C#" MasterPageFile="~/Common/Master/ZcMng.master" AutoEventWireup="true" CodeFile="ShenPiZcDone.aspx.cs" Inherits="ZcMng1_ShenPiZcDone" Title="我审批过的资产" %>
<%-- 在此处添加内容控件 --%>
<%-- 在此处添加内容控件 --%>
